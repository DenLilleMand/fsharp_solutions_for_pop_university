...
\newcommand{\hmwkTitle}{POP \#9} % Assignment title
\newcommand{\hmwkDueDate}{Onsdag,\ December\ 15,\ 2016} % Due date
...
{\Large Opgave 9}\\[0.75\baselineskip] % Title line 2
...
\section{Eksekvering af program}
\input{program}
